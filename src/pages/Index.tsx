      ...
      <div className="max-w-5xl mx-auto">
        <section className="py-12 md:py-16 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto text-gray-600 mb-8">
            Your interactive resource for mastering English vocabulary and grammar with Arabic translations.
          </p>
        ...
        <section className="py-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">Get valuable tips to enhance your language learning experience.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 text-center">
          ...
          <p className="text-gray-600 mb-6">Explore our vocabulary flashcards and grammar explanations.</p>
          <div className="flex flex-wrap justify-center gap-4">
